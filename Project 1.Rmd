...
```{r}
str(listings)
model1 <-lm(prosper_score ~ loan_status + prosper_rating + scorex + income_range + income_range_description + employment_status_description + occupation + borrower_state + borrower_city + loan_status_description, data = listings)
summary(model1)
```
