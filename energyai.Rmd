...
energy_labels <- energy_dt_train[,1]

knnmodel <- knn(train = energy_train, test = energy_test, cl = energy_labels, k = 137)
#str(energy_y)
summary(energy_labels)
summary(knnmodel)
confusionMatrix(knnmodel, as.factor(energy_labels))
...
cor(predicted_Appliance, energytest$Appliances)
