...
```{r}
logit<-glm(Appliances ~., data = energydata)
summary(logit)
...
testset <- sample(1:nrow(energydata), 3947)

energytest <- energydata[testset,]
energytrain <- energydata[-testset,]
