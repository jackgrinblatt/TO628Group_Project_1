...
--- NOTES ---
1. Make ANN more compled and Remove ANN Confusion Matrix (not applicable for continuous), replace with MSE/MAPE (Eliada)
2. Optimize KNN (#k) (Ketan)
3. Repair Decision Tree (Jon)
4. Analysis (Jack)
