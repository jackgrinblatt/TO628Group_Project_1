...
The objective of this analysis is to model factors that translate to effect on borrower rate at Prosper. The outcome of this analysis will allow Prosper to adjust borrower rate methodology as well as identify arbritrage opportunities.
...
Linear Regresion Model 1: Includes Only Variables with Significant Correlation
```{r}
...
Linear Regression Model 2: Includes Only Variables with Statistically Significant Contriution and Large Coefficient (> 10^-5)
```{r}
