---
title: "Analysis of Prosper Borrower Rates"
...
The objective of this analysis is to model factors that translate to effect on borrower rate at Prosper. The outcome of this analysis will allow Prosper to adjust borrower rate methodology as well as identify arbitrage opportunities.

## Methodology
1. Import Data
2. Cleanse Data
3. Run Linear and Logistic Regression Models
...
## 3. Build Linear & Logistic Regression Models 
Linear Regression Model 1: Includes Only Variables with Significant Correlation
```{r}
...
Linear Regression Model 2: Includes Only Variables with Statistically Significant Contribution and Large Coefficient (> 10^-5)
```{r}
...
The objective of this analysis was to determine relevant factors for determining credit rating, as well as dispel any myths regarding factors that don't truly matter.
...
### Suprises
Contrary to public opinion and logic, the models show that the increase in delinquencies translate to a higher credit score. It's possible that this is mechanically set to increase the pool of high-interest and high-fee consumers which may have a larger CLV, however more investigation is needed.

### Future Implications
Given these findings, we recommend an adjusted approach to setting consumer rates at Prosper. Using a model as simple as KNN or as complex as ANN, Prosper can segment and classify future customers based on the factors that truly matter to credit rating, thereby increasing its chances of higher quality customers and reduced uncollectables.
